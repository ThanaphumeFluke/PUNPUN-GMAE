//level = 3
var random1, random2, random3, random4, result, ans
var inop1, op1_value, inop2, op2_value, inop3, op3_value
...
function findnumber() {
  ...
  if (op1 < 2 && op2 > 1 && op3 > 1) {
    result = operator(random1, operator(operator(random2, random3, op2), random4, op3), op1)
    if (result >= 100 || result <= 0 || result - Math.floor(result) != 0) {
      return findnumber();
    }
    return result;
  }
  else if (op1 < 2 && op2 > 1 && op3 < 2) {
    result = operator(operator(random1, operator(random2, random3, op2), op1), random4, op3)
    if (result >= 100 || result <= 0 || result - Math.floor(result) != 0) {
      return findnumber();
    }
    return result;
  }
  else if (op1 < 2 && op2 < 2 && op3 > 1) {
    result = operator(operator(random1, random2, op1), operator(random3, random4, op3), op2)
    if (result >= 100 || result <= 0 || result - Math.floor(result) != 0) {
      return findnumber();
    }
    return result;
  }
  else if (op1 > 1 && op2 < 2 && op3 > 1) {
    result = operator(operator(random1, random2, op1), operator(random3, random4, op3), op2)
    if (result >= 100 || result <= 0 || result - Math.floor(result) != 0) {
      return findnumber();
    }
    ...
    result = operator(operator(operator(random1, random2, op1), random3, op2), random4, op3)
    if (result >= 100 || result <= 0 || result - Math.floor(result) != 0) {
      return findnumber();
    }
    return result;
...
function check(input1, input2, input3) {
  if (input1 < 2 && input2 > 1 && input3 > 1) {
    ans = operator(random1, operator(operator(random2, random3, input2), random4, input3), input1)
  }
  else if (input1 < 2 && input2 > 1 && input3 < 2) {
    ans = operator(operator(random1, operator(random2, random3, input2), input1), random4, input3)
  }
  else if (input1 < 2 && input2 < 2 && input3 > 1) {
    ans = operator(operator(random1, random2, input1), operator(random3, random4, input3), input2)
  }
  else if (input1 > 1 && input2 < 2 && input3 > 1) {
    ans = operator(operator(random1, random2, input1), operator(random3, random4, input3), input2)
  }
  else {
    ans = operator(operator(operator(random1, random2, input1), random3, input2), random4, input3)
  }
  if (result == ans) {
...
function submitted() {
  ...
  check(op1_value, op2_value, op3_value)
}
